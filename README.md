...
open; Q12, KUD and Lorentz (a proved negative result about a posited truncation) proved; Cosmology heuristic; O22 structural; the O4 and O6 rows and paragraphs state the current negative results.
