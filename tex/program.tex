...
\begin{document}
  ...
  \subsection{O16--O24: Pair Observable and Closure of the Fibre-Level Transfer Chain}
    ...
    coupling hypotheses and the power-law regime remain its standing conditions, and the numerical
    value remains open pending $\delta_\infty$).
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
  ...
  O4--O6 growth-equation closure and coupling hypotheses and the power-law regime as standing
  conditions --- and numerically validated it up to $q = 601$~(O25).
