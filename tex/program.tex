...
\begin{document}
  ...
  [H-color] proved analytically via O31 v1.5).
    ...
    An exhaustive audit of all normalised parameters and pre-saturation depths through
    $q=73$ finds no other order; completeness of the $C_2,C_4,C_6$ list remains conjectural.
