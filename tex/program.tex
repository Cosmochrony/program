...
\date{2026\\[2pt]\small Version 2.21}
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      (as are the Q5b, Q6b, Q8, U1, W1 and Q11 rows, for the same reason) &
      \scond{} on [U] \\[3pt]
      ...
      Item~(iii) of its Corollary ``Closure of Q10'' states that Q7's bridge conjecture is
      resolved; Q7 version~2.0 does not retain
  ...
  The Q5b, Q6b, Q8, Q10, U1, W1 and Q11 entries are pending revision in the cascade that
