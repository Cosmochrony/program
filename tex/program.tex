...
\subsection{O1--O8: LPS Phase --- Cascade Exponent \texorpdfstring{$\beta$}{beta}}
  ...
  sub-programme}, whose synthesis paper is the presentation note \textbf{EG-Note}~\cite{Beau2026egnote}.
    ...
    observables ($\mathcal{O} = \mathrm{Im}\,\Pi$), made quantitative by
    U1 (\scond{} on the Q5a--Q5b hypotheses).
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{figure}[p]
      ...
      \textbf{Q9}~(\scond{} on [H-F]; the implication itself is \sproved): under the frozen, unestablished
        ...
        \textbf{Q10}~(\scond{} on~[U]): universality~[U] $\Rightarrow$ $\mathfrak{su}(2)$-isotropy
        $\Rightarrow$ $A_H \to 2$.
        ...
        \textbf{W1}~(\scond{} on [H1] and [H2]): [H-w] as a structural consequence of fibre-invariance
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      \scond{} on the power-law Ansatz\ /\ \sopen \\[3pt]
      ...
      exponent window &
      \scond{} on its two persistence hypotheses \\[3pt]
      ...
      \scond{} on the matched coefficients \\[3pt]
