...
\subsection{O1--O8: LPS Phase --- Cascade Exponent \texorpdfstring{$\beta$}{beta}}
  ...
  \subsection{O25--O30, PTO, and Fibre Erasure: Numerical Validation, Carrier Diagnostics, a Conditional Covariance Model, and Information-Theoretic Axes}
    ...
    Version~2.0 takes the pair-sector fibre structure as a structurally motivated hypothesis (O18 states
    ...
    the quotient identification (Level~II) and the canonical representation-theoretic identification
    in an isotypic sector of $2I$ (Level~III) are conditional on the admissible embedding
    $\Phi_{q,\rho}$, with falsifiability tests through the effective dimension of the trajectory in
    $\mathrm{End}(V_\rho)$ computable from O25 data.
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      Hilbert--Schmidt trajectory norm proved; Levels II--III conditional on the admissible embedding
      $\Phi_{q,\rho}$, falsifiable through $r_{\mathrm{eff}}$ on O25 data; no rate equation follows &
      \sstruct \\[3pt]
      ...
      does not correct the intra-$q$ fitted exponent (a diagnostic, not a corrected exponent); $1\%$ threshold rank
      ...
      remaining open: explicit $1-P(s)$ (structurally constrained by EBJ, version 2.1), amplitude $|u|$, Yukawa &
      \sstruct \\[3pt]
