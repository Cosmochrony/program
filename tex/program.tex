...
\begin{document}
  ...
  The corpus comprises 110 papers with complex mutual dependencies.
  ...
  \subsection{O25--O30, PTO, and Fibre Erasure: Numerical Validation, Sector Identification, Eigenvalue Ratio, and Information-Theoretic Axes}
    ...
    viable at $q \le 601$); as a separate numerical comparison the candidate parameter
    $\beta^* = 1/(\delta_{\mathrm{pair}} + \tfrac12)$ stays in the narrow band $0.108$--$0.123$,
    near the mass-fitted window.
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.45cm}p{2.9cm}p{1.3cm}p{6.5cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      candidate $\beta^* \in 0.108\text{--}0.123$ as a phenomenological comparison &
      \sstruct \\[3pt]
