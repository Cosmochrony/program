...
\subsection{O1--O8: LPS Phase --- Cascade Exponent \texorpdfstring{$\beta$}{beta}}
  ...
  \subsection{Standard Model Companion Papers}
    ...
    construction alone. Version 1.2 integrates the analytical results of ENT-E1 (Weil fingerprint
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
      ...
      Colour coding: \textcolor{cproved}{$\blacksquare$}~\sproved{},
        ...
        Papers whose status is numerical (O29) or conditional (O30) are drawn with the structural style
        here and carry their own status in the interactive graph, whose conditional-reading edges
        (EG-Note to Q12, Q13 and Q14) are not drawn in this figure.
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      falsifiable through $r_{\mathrm{eff}}$ on O25 data; no rate equation follows &
      \sstruct \\[3pt]
