...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
  ...
  \paragraph{$V-A$ chiral structure and fermionic matter (Q14).}
    ...
    The intrinsic depth carrier therefore remains open in a more constrained form: the only positive route left is a
    decaying capacity-controlled per-level profile $\sigma_{\lambda_g}(n)$ transported onto the cascade, a distinct
    object not extracted from the linear count, deferred to a later front.
