...
\date{2026\\[2pt]\small Version 2.10}
...
\begin{document}
  ...
  \subsection{Branch~I Synthesis: NIF-Note}
    ...
    the Born rule, open at every sector and not derived by Q1--Q3, and the Level~2 scale
    determination of noscale (every emergent scale as a functional of~$c_{\mathrm{BI}}$ alone).
  ...
  \subsection{Q-Series: Quantum Mechanics and Spacetime Emergence}
    ...
    theorem in the finite Weil representation of the Heisenberg group (\sproved), and a
    ...
    hypothesis (\sstruct): given a supplied bipartite carrier $V_{\chi_{2j+1}}\otimes
  ...
  sub-programme}, whose synthesis paper is the presentation note
    ...
    \emph{Quantum Reports}), independently of Q1--Q3.
  ...
  \subsection{Standard Model Companion Papers}
    ...
    $S_{\mathrm{ent}}^{\mathrm{adm}}=\log 2$ for general canonical blocks, conditional on Q3's
    explicit, undemonstrated diagonal-invariance hypothesis (\sstruct). Q1 does not establish a
    singlet correlator or a Tsirelson bound. The \emph{full residual-rank entropy}
