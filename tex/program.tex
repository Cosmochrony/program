...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      conditional on the independent [H-L] and on the identification Q7 version~2.0 records as
      ...
      \scond{} on the Q5a Mosco hypotheses ([H1], [H-w], [H-$\mathcal{E}$1], Conjecture~C), [H-L] and
