...
\subsection{O1--O8: LPS Phase --- Cascade Exponent \texorpdfstring{$\beta$}{beta}}
  ...
  \subsection{Lorentz Capacity Sub-Programme}
    ...
    Gravitational time dilation is identified as $d\tau/dn|_x = R(x)/\gamma$; the capacity radius is not the
    metric radius, the two agreeing only at $\epsilon(x) = 0$ (LCIIo1~\cite{Beau2026lco2o1}).
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      \sproved\ /\ \scond{} on postulate [H2] for the instantiation \\[3pt]
      \midrule
      ...
      \sproved{} (negative, about the posited truncation); \scond{} on $T^{(\Pi)}_{0i}$; \sopen{} (Lorentzian
      construction) \\[3pt]
