...
\begin{document}
  ...
  sub-programme}, whose synthesis paper is the presentation note \textbf{EG-Note}~\cite{Beau2026egnote}.
    ...
    Q13 joins the metric and connection variations of a single renormalized local action and
    obtains a \emph{conditional} Einstein--Yang--Mills system.
    ...
    $a_6 \to$ mixed invariants (inventory only),
