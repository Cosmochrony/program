...
\begin{document}
  ...
  \subsection{Cosmological and Condensed-Matter Applications}
    ...
    the projective history record; the finite-$n$ profile is retained as the candidate input for an evolving
    effective equation of state, deferred to the cosmological branch.
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.45cm}p{3.4cm}p{1.5cm}p{6.5cm}p{1.3cm}@{}}
      ...
      (generic $a$-mirror separation via the mixed two-anchor coefficient; $w(n)$ candidate) &
      \sproved \\[3pt]
