...
\begin{document}
  ...
  \paragraph{Conventions on result status.}
    ...
    principal contribution, the result named by its title: a proved no-go or countermodel is \sproved{} as a
    negative result, and a withdrawal notice with no new theorem is \sopen{}.
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      \sstruct{} (geometry); \scond{} on [H-F] and [H-L] (metric chain) \\[3pt]
      ...
      \sstruct{} (isotropy); \scond{} (bridge) \\[3pt]
