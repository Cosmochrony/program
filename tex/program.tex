...
\begin{document}
  ...
  sub-programme}, whose synthesis paper is the presentation note \textbf{EG-Note}~\cite{Beau2026egnote}.
    ...
    GGS-Note itself still presents the earlier chain (full horizontal--vertical decoupling,
    a unique $a_6$ cross-term, an Eddington--Born--Infeld completion and a tuning-free hierarchy)
    and therefore requires a corrective revision to align it with Q12 and Q13; that revision is
