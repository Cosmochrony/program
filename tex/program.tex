...
\date{2026\\[2pt]\small Version 2.4}
...
\begin{document}
  ...
  \begin{abstract}
    ...
    observable states.
    The corpus comprises 114 papers across three theory branches.
  ...
  The corpus comprises 114 papers with complex mutual dependencies.
  The interactive dependency graph covers all 114 entries of the inventory and distinguishes
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    Table~\ref{tab:inventory} lists all 114 papers of the programme, the present registry excepted.
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      \caption{Complete inventory of the 114 programme papers, excluding the present registry.}
      \label{tab:inventory}\\
      \toprule
