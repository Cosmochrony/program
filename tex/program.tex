...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      Discharges PRS open deliverable~1 structurally: for every smooth family and every smooth unitary transport the
      self-adjoint projector jet $1-P(s) = Q_0 + sQ_1 + s^2Q_2 + O(s^3)$ is constrained --- $Q_1 = [A, Q_0]$ is a
      purely off-diagonal Grassmann tangent ($Q_0 Q_1 Q_0 = 0 = (1-Q_0)Q_1(1-Q_0)$), $Q_2$ diagonal blocks pinned to
      $Q_1^2$ with opposite signs; the parity grading holds under $J_\Pi$-equivariance, and with a moving spinorial
      embedding and a $J_\Pi$-even Dirac operator the residue jet is graded $E_0$ even, $E_1$ odd, with first-order
      odd part $\{E_0, E_1\}$ and $u'(0) = \langle J_3, \{E_0, E_1\}\rangle/\langle J_3, J_3\rangle$;
      ...
      $u'(0) = 11 \cdot 2^{1/4}/9 \neq 0$;
      since $J_\Pi$ exchanges chiralities, $[\Pi_{J_\Pi\text{-odd}}(1-P)]_{LL} = \tfrac12\Delta_\chi(P)$ and
      ...
      selection of the family, localisation of the odd tangent, and normalisation of $\partial_s\Delta_\chi(P)|_0$
      open, $|u|$ dictionary-bound &
      \sstruct \\[3pt]
