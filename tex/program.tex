...
\begin{document}
  ...
  \begin{abstract}
    ...
    The corpus comprises 107 papers across three theory branches.
  ...
  The corpus comprises 107 papers with complex mutual dependencies.
  ...
  \subsection{Cosmological and Condensed-Matter Applications}
    ...
    $\log 2$: \sproved; exact class count: verified/conjectural; cosmological reading: \sstruct).
    ...
    generic probe (Lawrence--Pfander--Walnut full spark plus a Chebotar\"ev-based separation lemma) the count is
    bracketed by $2^n$ and $2^{n+2}$: exactly pinned compression rate $\log 2 < \log(1+\sqrt2)$, with the
    finite-$n$ profile retained as the candidate input for an evolving effective equation of state, deferred to
    the cosmological branch.

    \textbf{LowLCapacity}~\cite{Beau2026dhc}: Low-multipole suppression from distinguishable-history capacity
    (mechanism and no-fit grid: \sstruct/numerical; entropy-to-power step and TE/EE transfer: \sopen).
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.45cm}p{3.4cm}p{1.5cm}p{6.5cm}p{1.3cm}@{}}
      ...
      compressive by geodesic death, pinned rate $\log 2$ ($w(n)$ candidate) &
      \sproved \\[3pt]
