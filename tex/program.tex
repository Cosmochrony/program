...
\begin{document}
  ...
  \subsection{O25--O30, PTO, and Fibre Erasure: Numerical Validation, Sector Identification, Eigenvalue Ratio, and Information-Theoretic Axes}
    ...
    the adjoint carrier (interpretation), correlated with O18's proposed, unproved Born--Infeld
    parity involution $c \leftrightarrow q-c$.
  ...
  \subsection{Q-Series: Quantum Mechanics and Spacetime Emergence}
    ...
    parity-to-fibre and substrate-to-character bridges; the resulting singlet and Tsirelson chain
    is therefore not unconditional (\sstruct{} under open upstream premises).
    ...
    \begin{figure}[p]
      ...
      \resizebox{\textwidth}{!}{%
        \begin{tikzpicture}[
          ...
          \node[Oc] (O22)  at (4*\dx,-5*\dy)   {O22};
          \node[P] (O23)  at (5*\dx,-5*\dy)   {O23};
          \node[Oc] (O24)  at (6*\dx,-5*\dy)   {O24};
