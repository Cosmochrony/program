...
\begin{document}
  ...
  \begin{abstract}
    ...
    Its stabiliser analysis now includes an orbit-divisibility sieve and uniform exact
    $C_4$ and $C_6$ exceptional families; completeness of those two exceptional orders is
    supported exhaustively through $q=73$ but remains open.
  ...
  [H-color] proved analytically via O31 v1.5).
    ...
    three-character filtration (draft; exact core).
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.45cm}p{3.4cm}p{1.5cm}p{6.5cm}p{1.3cm}@{}}
      ...
      stabiliser reduced exactly to $A_K$, with an orbit-divisibility sieve and uniform
      exact $C_4,C_6$ families (completeness open);
