...
\date{2026\\[2pt]\small Version 2.7}
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.70cm}p{2.9cm}p{1.3cm}p{6.25cm}>{\raggedright\arraybackslash}p{2.0cm}@{}}
      ...
      under postulate H2 on the TrajectoryBranching automaton; endpoint/shadow quotients incomparable;
      ...
      doubling beyond $V_\rho$, a canonical inter-sector identification, and the condensation
      dynamics itself) &
      \sproved\ /\ \sopen \\[3pt]
      \midrule
