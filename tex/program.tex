...
\begin{document}
  ...
  sub-programme}, whose synthesis paper is the presentation note \textbf{EG-Note}~\cite{Beau2026egnote}.
    ...
    $I_\rho/(12\cdot 16\pi^2)$, depending on the representation through the Dynkin index $I_\rho$
    ...
    What is structural is the difference in UV divergence degree between the two sectors ---
    quadratic at $a_2$ for gravity, logarithmic at $a_4$ for gauge; no predictive $G_N$ formula
    and no tuning-free hierarchy is claimed (aligned with Gravity~3.3).
