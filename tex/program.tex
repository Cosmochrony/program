...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{figure}[p]
      ...
      \textbf{Q9}~(\scond{} on [H-F]; the implication itself is \sproved): under the frozen, unestablished
        ...
        unestablished spatial-limit hypothesis [H-L] of Q5a version 3.2/Q5b version 2.1, and, since
        Q7 version~2.0, on the identification of the measured admissible space with the spin-$1$
        module, which no paper supplies: Q7 is \sproved{} for the requirements it states on the
