...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
      ...
      \resizebox{\textwidth}{!}{%
        \begin{tikzpicture}[
          ...
          \node[S] (Q11) at (\dx+0.5*\dx,-6*\dy)
            {Q11\\{\tiny $A_\tau\!=\!2$ under [H-F]; pending}};
  ...
  \paragraph{Bridge existence at finite $q$ (Q7--Q10).}
    ...
    Open in either case is the structural question of Q7 version~2.0 Conjecture~4.7: whether,
    under [ID] and [ACT], a non-zero $\mathfrak{su}(2)$-equivariant map
    $\varphi : \mathrm{Sym}^2(V_\rho) \to W_{\mathrm{sp}} \otimes_\mathbb{R} \mathbb{C}$ exists at all.
