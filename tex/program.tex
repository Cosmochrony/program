...
\begin{document}
  ...
  [H-color] proved analytically via O31 v1.5).
    ...
    Multi-prime audits find exact $C_4$ and $C_6$ stabiliser exceptions and
    character-selective cyclotomic cancellations; no Standard-Model or Dirac-mass
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.45cm}p{3.4cm}p{1.5cm}p{6.5cm}p{1.3cm}@{}}
      ...
      stabiliser reduced exactly to $A_K$ with $C_4,C_6$ exceptions;
