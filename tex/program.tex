...
\begin{document}
  ...
  [H-color] proved analytically via O31 v1.5).
    ...
    The eliminated residue supplies a second axis exactly when its cyclotomic phase
    ...
    Multi-prime audits also find character-selective cyclotomic cancellations;
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.45cm}p{3.4cm}p{1.5cm}p{6.5cm}p{1.3cm}@{}}
      ...
      boundary mixing controlled by an exact cyclotomic phase determinant;
