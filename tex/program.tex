...
\begin{document}
  ...
  \sim (12\cdot 16\pi^2)^{-1}\log(\Lambda/\mu)$,
    ...
    the chiral lift (\sproved\ for the gate and the chiral lift, with the full-tower generalisation \sopen).
    ...
    character-table audit of $2I$; only the full-tower generalisation remains \sopen.
...
% aggregates Q14, PRS, AAR, Q11OF, A4-Note and AOG-Note.
    ...
    \begin{longtable}{@{}p{1.45cm}p{3.4cm}p{1.5cm}p{6.5cm}p{1.3cm}@{}}
      ...
      $2I$, with only the full-tower generalisation open;
